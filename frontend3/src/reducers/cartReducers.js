...
export const cartReducer = (state = { cartItems: [] }, action) => {
  switch (action.type) {
    case CART_ADD_ITEM:
      ...
      if (existItem) {
        if (JSON.stringify(item) === JSON.stringify(existItem)) {
          return {
            ...state,
            warnMsg: "There is no change. Nothing to update!",
          };
        } else {
          ...
          return {
            ...
            informMsg: "Your item is updated successfully!",
          };
        }
      } else {
